...
const ChallengerGame = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-[64px] md:mt-[104px] '>
        <div className='flex gap-[2.76px] bg-[#0D0D0D] w-full pl-[24px] md:px-[56px] h-[40px] md:h-[90px] items-center overflow-scroll'>
        {
        numbers.map((item) => 
        <div className={`${item==1?"w-[46.22px] md:w-[104px] bg-black h-[40px] md:h-[90px] rounded-t-[7px] md:rounded-t-[8px] ":"bg-[#262626] h-[25.22px] md:h-[58px] w-[46.22px] md:w-[104px] rounded-[7px] md:rounded-[16px]"}
        ...
        <div className="mx-auto w-fit">
          ...
          <button className=" border-blue-main mt-[8px] font-[900] text-[17px] md:text-[32px] font-Archivo-Bold text-white  mx-auto w-[157px] md:w-[472px] h-[59px] md:h-[84px] rounded-[8px] border-[2px] bg-[#0855AB]">
            3
          </button>
        </div>
        ...
        <div className="flex flex-col gap-[24px] w-full mt-[64px] font-Archivo_Regular text-[20px] ">
          ...
          <button className="bg-[#D92D20]  text-white h-[96px] w-full rounded-[16px] ">
          DISAPPROVED GAME
          </button>
        </div>
        </div>
        ...
        <div className="text-white font-Archivo_Regular text-[20px]  bg-[#0D0D0D]  rounded-[24px]  pb-[55px]">
