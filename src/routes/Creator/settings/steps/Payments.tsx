          ...
          <div className=" text-white ">
            <div>
              <div>
                <Input
                  ...
                  type="number"
                />
                <p className="font-[300] text-wb-40 font-Archivo_Regular mt-[8px] leading-[17.41px] text-[14px] md:text-[16px]">
                  {" "}
                  e.g 3.5 Aurora Token
                </p>
              </div>
            ...
            <div>
              <div className="flex justify-between items-end md:items-center mt-[32px] flex-col md:flex-row">
                <p className="font-Archivo_Regular leading-[17.41px] text-white font-normal order-2 md:order-1">
                  How do you want the price shared amongst the runner-up?
                </p>
                <button
                  onClick={() => setPriceShare((prev: any) => [...prev, ""])}
                  className="mb-[24px] md:mb-0 order-1 md:order-2 flex items-center text-white font-Inter_Regular font-medium text-[14px] gap-[8px] py-[10px] px-[16px] settingsFormbutton rounded-lg "
                >
              ...
              <div className="w-full mt-5">
                <button
                  onClick={() =>
                    setPriceShare((prev: any) =>
                      prev.length > 1 ? prev.slice(0, prev.length - 1) : [""]
                    )
                  }
                  className="mb-[24px] md:mb-0 order-1 ml-auto md:order-2 flex items-center text-white font-Inter_Regular font-medium text-[14px] gap-[8px] py-[10px] px-[16px] settingsFormbutton rounded-lg "
                >
            ...
            <button
              ...
              onClick={() => {
                ...
                if (!checkAmount(priceShare, gameToken)) {
                  setErrorMessage(
                    "Amount to deposit not equal to amount to share!"
                  );
                  return;
                }
                const get = async () => {
