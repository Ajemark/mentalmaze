    ...
    return (
        <div className=''>
         <div className='px-[16px] md:px-[48px]'>
          ...
          <p className='font-[300] text-wb-40 font-Archivo_Regular mt-[4px] md:mt-[8px] leading-[17.41px] text-[14px] md:text-[16px]'> You Are Advised To Use The Same Discord</p>
          </div>
