...
const Create = () => {
  return (
    games.length > 0?
    <div className="grid  grid-cols-2 md:grid-cols-3 gap-x-[45px] gap-y-[44px] py-[72px] mt-[104px] px-[16px]">
        ...
        <button className='font-droid text-[12px] md:text-[24px] md:leading-[28.34px] text-white py-[16px] level px-[24px] rounded-[8px] border-[2px]  border-[#063C7A]'>
            CREATE GAME
        </button>
        </div>
