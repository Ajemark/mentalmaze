...
const ChooseANickname = () => {
  ...
  return (
    ...
    <Animation className='pt-[48px] flex flex-col h-full gap-[100px] px-[29.5px] md:px-0'>
          <input type="text" ref={inputRef} onKeyDown={onSubmit} placeholder='ENTER YOUR NICKNAME' className='font-[400] text-[15px] md:text-[20px] font-droid leading-[23.61px] py-[24px] px-[40px] text-[#8C8C8C] rounded-[16px] md:rounded-t-[16px] w-full bg-blue-90 md:w-[416px] mx-auto text-center' />  
